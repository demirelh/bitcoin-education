...
Templates: `correct_transcript.md`, `translate.md`, `adapt.md`, `chapterize.md`, `imagegen.md`, `system.md`, `intent_extract.md`, `stock_rank.md`
...
- All templates target `claude-sonnet-4-20250514` model
